...
module RAM_WAVEFORM_FULL#(
    ...
    localparam RAM_DATA = {6'd0, 6'd2, 6'd5, 6'd8, 6'd11, 6'd14, 6'd17, 6'd20, 6'd23, 6'd26, 6'd29, 6'd31, 6'd29, 6'd26, 6'd23, 6'd20, 6'd17, 6'd14, 6'd11, 6'd8, 6'd5, 6'd2, 6'd0};
    ...
    BRAM_SINGLE#(BITWIDTH, RAMWIDTH) BRAM(
        .CLK_RAM(CLK_SYS),
        .EN(state || RAM_WE),
        .WE(RAM_WE),
        //.PREDEFINED(RAM_DATA),
