...
cocotb_settings = dict(
    src_files=['ring_buffer.v', 'windower.v'],
    top_module_name='WINDOWER',
    cocotb_test_module='elasticai.creator_plugins.windower.tests.windower_tb',
