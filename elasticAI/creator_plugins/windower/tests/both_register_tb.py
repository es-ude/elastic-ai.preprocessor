...
cocotb_settings = dict(
    src_files=['shift_register.v', 'ring_buffer.v', 'both_register.v'],
    top_module_name='BOTH_REGISTER',
    cocotb_test_module='elasticai.creator_plugins.windower.tests.both_register_tb',
...
@cocotb.test()
async def both_register_tb(dut):
    period_clk = 5
    print(dir(dut))
