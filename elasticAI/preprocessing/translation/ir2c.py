...
def get_embedded_datatype(bitwidth: int, signed: bool) -> str:
    ...
    return ('' if signed else 'u') + 'int' + f'{bit_compare[used_bitval]}' + f'_t'
...
def generate_c_files(path2save: str, template_name: str, file_name: str, module_id: str,
                     proto_file: list, impl_file: list, path2template:str='./../c') -> None:
