...
from elasticai.preprocessing.filter import SettingsFilter, Filtering
...
def build_filter_iir(settings: SettingsFilter, bitwidth: int, signed: bool,
                     filter_id: str='', path2save:str=get_path_to_project("build"), define_path: str='src') -> None:
