...
from elasticai.preprocessing.filter import SettingsFilter
...
def build_filter_fir_allpass(settings: SettingsFilter, bitwidth: int, signed: bool,
                             filter_id: str='0', path2save: str=get_path_to_project("build"),
                             define_path: str='src') -> None:
