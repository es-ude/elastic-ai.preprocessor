...
from elasticai.preprocessing.filter import Filtering, SettingsFilter
...
def build_filter_fir(settings: SettingsFilter,
                     bitwidth: int, signed: bool, do_optimized: bool, filter_id: str= '0',
